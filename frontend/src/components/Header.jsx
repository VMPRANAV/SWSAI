    ...
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur border-b border-slate-200">
      <div className="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="relative">
          <button
            className="relative p-2 rounded-full transition hover:bg-slate-100"
          ...
          {isOpen && (
            <div className="absolute right-0 mt-3 w-96 bg-white text-slate-900 shadow-xl rounded-2xl z-50 border border-slate-200 overflow-hidden">
                ...
                {notifications.length === 0 ? (
                  ...
                  notifications.map((n) => (
                    <button
                      ...
                      className={`w-full text-left p-4 border-b border-slate-100 hover:bg-slate-50 transition ${!n.isRead ? 'bg-blue-50/60' : ''}`}
                    >
